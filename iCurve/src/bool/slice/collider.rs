...
use crate::kernel::math::rect::{ToIntRect, ToRect};
...
pub(crate) struct Collider<T: FloatNumber, I: IntNumber> {
    ...
    pub(super) segment: Segment<T>,
    pub(super) rect: IntRect<I>,
}

impl<T: FloatNumber, I: IntNumber> Collider<T, I> {
    #[inline]
    pub(super) fn new(index: usize, segment: Segment<T>, adapter: &FloatPointAdapter<FloatPoint<T>, I>) -> Self {
