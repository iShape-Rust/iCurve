...
impl<I: IntNumber> StackVec<IntPoint<I>, 4> {
    ...
    fn with_slice_as_convex(points: &[IntPoint<I>]) -> Self {
        let mut convex: StackVec<IntPoint<I>, 4> = StackVec::new();
        convex.init_as_convex(points);
        convex
    }

    fn init_as_convex(&mut self, points: &[IntPoint<I>]) {
...
mod tests {
    ...
    #[test]
    fn test_4() {
        let convex = StackVec::with_slice_as_convex(&[IntPoint::new(0, 0), IntPoint::new(10, -10), IntPoint::new(10, 10)]);
