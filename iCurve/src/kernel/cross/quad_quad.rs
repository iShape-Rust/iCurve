...
use crate::kernel::cross::overlap::find::FindOverlap;
use crate::kernel::cross::rect::FloatRectExt;
use crate::kernel::cross::solver::{IntersectionResult, QuadQuadPair, Solver};
...
impl<T: FloatNumber> Solver<T> {
    ...
    fn split_search(&mut self, quad0: QuadSegment<T>, quad1: QuadSegment<T>) {
