use crate::kernel::float::cross::overlap::find::{CurveOverlap, FindOverlap, find_bezier_overlap};
use crate::kernel::float::curve::cubic::FloatCubicSegment;
use i_overlay::i_float::float::number::FloatNumber;

impl<T: FloatNumber> FindOverlap<T> for FloatCubicSegment<T> {
